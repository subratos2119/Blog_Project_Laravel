          ...
          <div class="box box-primary">
            ...
            <form role="form" action="{{ route('post.update',$posts->id) }}" method="post">
              ...
              <div class="box-body">
                  ...
                  <input type="text" class="form-control" id="exampleInputTitle1" name="title" placeholder="Title" value="{{$posts->title}}">
                </div>
                <div class="form-group">
                  <label for="exampleInputSubtitle1">Post SubTitle</label>
                  <input type="text" class="form-control" id="exampleInputSubtitle1" name="subtitle" placeholder="SubTitle" value="{{$posts->subtitle}}">
                </div>
                <div class="form-group">
                  <label for="exampleInputSlug1">Post Slug</label>
                  <input type="text" class="form-control" id="exampleInputSlug1" name="slug" placeholder="Slug" value="{{$posts->slug}}">
                </div>
            ...
            <div class="box-body pad">
                <textarea class="textarea" name="body" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$posts->body}}</textarea>
            </div>
          </div>
